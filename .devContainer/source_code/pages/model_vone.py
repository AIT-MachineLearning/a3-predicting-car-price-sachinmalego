...
dash.register_page(__name__, path='/predictvone')
...
layout = dbc.Container([
    html.H3("Enter Car Details for Price Prediction Ver.2", style={'padding': '20px 0', 'color': '#004d00', 'font-weight': 'bold', 'textAlign': 'center'}),
    ...
    dbc.Row([
        ...
        dbc.Col(
            html.Div([
                ...
                html.Div(id="prediction-output-vtwo", className="mt-3", style={
...
@callback(
    Output(component_id="prediction-output-vtwo", component_property="children"),
